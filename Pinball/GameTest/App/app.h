...
namespace App
{
	...
	//-------------------------------------------------------------------------------------------
	// void DrawCircle(DrawCircle(float cx, float cy, float r, int num_segments);
	//-------------------------------------------------------------------------------------------
	// Draw a circle (multifaced polygon) with center [cx, cy] and radius r, with a number of faces equal to num_segments (default 12).
	//-------------------------------------------------------------------------------------------
	void DrawCircle(float cx, float cy, float r, int num_segments = 12);
